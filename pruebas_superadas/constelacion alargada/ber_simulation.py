...
# Generated: Mon Mar 16 10:45:36 2020
##################################################
...
class ber_simulation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.samp_rate_to_usrp = samp_rate_to_usrp = int(samp_rate_usrp_rx/64)
        self.Rs = Rs = Rb/Bps
    ...
    def set_samp_rate_usrp_rx(self, samp_rate_usrp_rx):
        ...
        self.set_samp_rate_to_usrp(int(self.samp_rate_usrp_rx/64))
