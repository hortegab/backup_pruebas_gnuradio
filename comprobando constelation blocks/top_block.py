...
# Title: Top Block
# Generated: Sat Feb 29 18:29:23 2020
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.digital_map_bb_0_0 = digital.map_bb((ci))
        self.digital_map_bb_0 = digital.map_bb((cr))
        self.blocks_vector_source_x_0 = blocks.vector_source_b((0,1, 2, 3, 3,2,1,0), True, 1, [])
        ...
        self.connect((self.blocks_char_to_float_0_1, 0), (self.blocks_float_to_complex_0, 1))
        self.connect((self.blocks_float_to_complex_0, 0), (self.qtgui_const_sink_x_0, 0))
        self.connect((self.blocks_vector_source_x_0, 0), (self.blocks_char_to_float_0_0, 0))
        self.connect((self.blocks_vector_source_x_0, 0), (self.digital_map_bb_0, 0))
        self.connect((self.blocks_vector_source_x_0, 0), (self.digital_map_bb_0_0, 0))
