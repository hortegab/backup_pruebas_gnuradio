...
# Title: Borrar
# Generated: Sun Oct 13 08:29:15 2019
##################################################
...
class borrar(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Borrar")
        ...
        self.settings = Qt.QSettings("GNU Radio", "borrar")
        ...
        self.epy_block_0 = epy_block_0.e_add_cc(escala=0.5)
...
def main(top_block_cls=borrar, options=None):
